package com.blockchain.bcx.client;

import com.blockchain.bcx.config.ClientConfig;
import com.blockchain.bcx.decoders.EventDecoder;
import com.blockchain.bcx.encoders.ActionEncoder;
import com.blockchain.bcx.handlers.*;
...
import com.blockchain.bcx.model.actions.*;
import com.blockchain.bcx.model.events.*;
...
public class BcxClient implements ExchangeClient {
    private static final String BCX_WS_ENDPOINT = "wss://ws.prod.blockchain.info/mercury-gateway/v1/ws";
