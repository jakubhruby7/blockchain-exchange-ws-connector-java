package com.blockchain.bcx.decoders;
...
import static com.blockchain.bcx.utils.JsonUtils.fromJson;
import static com.blockchain.bcx.utils.JsonUtils.isJsonValid;
...
public class EventDecoder implements Decoder.Text<Event> {
    ...
    public void init(EndpointConfig config) {
        logger.debug("EventDecoder -init method called");
    }

    @Override
    public void destroy() {
        logger.debug("EventDecoder - destroy method called");
    }
}
